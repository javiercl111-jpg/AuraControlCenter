...
export class ReportDesignSystem {
  public branding: ExecutiveBrandingProfile;

  // PAGE
  public readonly pageWidth = 210; // A4 width mm
  public readonly pageHeight = 297; // A4 height mm
  ...
  public readonly safeAreaWidth = this.pageWidth - this.margin.left - this.margin.right;
  public readonly headerHeight = 20;
  public readonly footerHeight = 20;
  ...
  public readonly colors: {
    ...
    surfaceHover: [number, number, number];
  ...
  // TYPOGRAPHY
  public readonly typography: {
    displayTitle: TypographyToken;
    coverSubtitle: TypographyToken;
    sectionTitle: TypographyToken;
    subsectionTitle: TypographyToken;
    cardTitle: TypographyToken;
    body: TypographyToken;
    bodyEmphasis: TypographyToken;
    metricLarge: TypographyToken;
    metricLabel: TypographyToken;
    caption: TypographyToken;
    footer: TypographyToken;
    confidentialLabel: TypographyToken;
  };

  constructor(branding: ExecutiveBrandingProfile) {
