...
class ReportPdfGenerator {
    ...
    static addWatermark(doc, company, contact) {
        ...
        doc.setFontSize(8);
        doc.setFont("helvetica", "bold");
        doc.text(`CONFIDENCIAL - EXCLUSIVO PARA ${company.toUpperCase()}`, aura_executive_documents_1.AuraDesignTokens.margin.left, aura_executive_documents_1.AuraDesignTokens.pageHeight - aura_executive_documents_1.AuraDesignTokens.margin.bottom + 10);
