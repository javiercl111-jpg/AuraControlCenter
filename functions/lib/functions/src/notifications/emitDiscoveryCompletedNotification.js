...
exports.emitDiscoveryCompletedNotification = void 0;
const tasks_1 = require("firebase-functions/v2/tasks");
const google_auth_library_1 = require("google-auth-library");
// Retries and backoff matching user requirements
exports.emitDiscoveryCompletedNotification = (0, tasks_1.onTaskDispatched)({
    ...
    if (typeof payload.discoverySessionId !== 'string' || payload.discoverySessionId.length > 128 ||
...
//# sourceMappingURL=emitDiscoveryCompletedNotification.js.map