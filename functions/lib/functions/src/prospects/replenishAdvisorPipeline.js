...
exports.replenishAdvisorPipeline = (0, https_1.onCall)({
    ...
    if (!allowedRoles.includes(caller.role)) {
        throw new https_1.HttpsError("permission-denied", "Rol insuficiente para reponer prospectos.");
    }
    ...
    if (!advisorId) {
        throw new https_1.HttpsError("failed-precondition", "No se encontró el perfil de asesor comercial del usuario.");
    }
