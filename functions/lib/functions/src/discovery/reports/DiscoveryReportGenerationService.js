...
exports.DiscoveryReportGenerationService = void 0;
...
class DiscoveryReportGenerationService {
    /**
    ...
    static async generateReport(sessionId, prospectId, reportType, forceRegenerate = false) {
        ...
        const deliveryLevel = "ALLOW_FULL"; // In real app from DiscoverySecurityLayer
        ...
        return await db.runTransaction(async (t) => {
            ...
            if (existingMetadata.exists) {
                const data = existingMetadata.data();
            ...
            if (result.metadata?.status === "GENERATING" && result.message === "Generation started.") {
                ...
                try {
                    ...
                    const finalMetadata = (await metadataRef.get()).data();
                    return {
                        success: true,
                        reportId,
...
exports.DiscoveryReportGenerationService = DiscoveryReportGenerationService;
//# sourceMappingURL=DiscoveryReportGenerationService.js.map