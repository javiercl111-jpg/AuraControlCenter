...
function fromFirestoreValue(f) {
    ...
    if (f.nullValue !== undefined)
        return null;
    if (f.arrayValue !== undefined)
        return (f.arrayValue.values || []).map(fromFirestoreValue);
...
async function main() {
    ...
    async function fetchREST(url, method = "GET", body = null) {
        const options = {
            method,
            headers: {
...
main();
//# sourceMappingURL=remediatePlatformIdentities.js.map