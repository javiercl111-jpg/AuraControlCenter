...
const DISC_INT_03_PROJECT_NAME =
  "aura-control-center-preview";

const DISC_INT_03_VERCEL_PROJECT_ID =
...
export async function runFinalLiveCeremonyLauncherV1({
  browserProofCustody,
  policyVersion,
  postDeployRuntimePreparation,
} = {}) {
  if (
    postDeployRuntimePreparation !== undefined &&
    typeof postDeployRuntimePreparation !== "function"
  ) {
    throw new Error("D2E4X_RUNTIME_PREPARATION_REJECTED");
  }
  const resolvedPolicyVersion =
  ...
  try {
    ...
    const livePreviewAdapter =
      new RealVercelPreviewCeremonyAdapterV1({
        ...
        target: Object.freeze({
          ...D2E4D_TARGET,
          projectName: DISC_INT_03_PROJECT_NAME,
    ...
    if (postDeployRuntimePreparation) {
    ...
    const previewTarget =
      Object.freeze({
        ...
        projectName: DISC_INT_03_PROJECT_NAME,
        projectId: DISC_INT_03_VERCEL_PROJECT_ID,
        gitBranch: DISC_INT_03_GIT_BRANCH,
      });
